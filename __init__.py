...
class Model:
    def __init__(self, callback=None, id=None, provider=None, boost=1, env=None, errorcallback=None, checkfreq=2):
        ...
        self.contract_abi = json.loads(open(os.path.join(os.getcwd(), "info/contract_abi.json"), "r").read())
        self.contract_address = Web3.to_checksum_address(open(os.path.join(os.getcwd(), "info/contract_abi.json"), "r").read())
